...
%% Inputs
% 1: data_x - nSubj=size(data_x,1);
% 2: data_y - nSubj=size(data_x,1);
...
%This is not assumption of SnPM...
...
%         disp('ERROR: comparison not written yet!');
%     case 'correlationleft'
%         disp('ERROR: comparison not written yet!');
    case {'correlationboth','correlationright','correlationleft'}
