function [signal_info, num_calibrations, calibrations] = mff_import_signal_info(file)
    ...
    while ~feof(id)
        %% SECTION  - reads the various types of data sections 
        % at this point calibrations is considered a section type but this
        % should probably be split into <generalInformation> and
        % <calibration>
        line = fgetl(id);
